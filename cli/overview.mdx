...
description: "The @iris-code/cli package brings Iris Code health analysis to any terminal, build script, or CI pipeline. Fourteen commands cover scanning, gating, secrets, security smells, dependencies, CVEs, SBOMs, agent rules, Slack notifications, and hooks."
---
