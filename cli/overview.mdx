...
The Iris Code CLI runs the same health analysis as the VS Code extension from any terminal, build script, or CI pipeline - no editor required. Install it once, point it at any file or directory, and get the same scores and findings you see inline in your editor.
...
- **`iris check --changed`** - scan staged, unstaged, and untracked files that are not Git-ignored
