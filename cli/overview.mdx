...
description: "The @iris-code/cli package brings Iris health analysis to any terminal, build script, or CI pipeline. Twelve commands cover scanning, gating, secrets, security smells, deps, CVEs, SBOMs, and hooks."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Commands" icon="terminal" href="/cli/commands">
    Full reference for all twelve Iris CLI commands, flags, and exit codes.
  </Card>
