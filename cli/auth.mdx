...
`iris auth login` is fully interactive - it prompts you to choose between a browser sign-in and pasting a licence token. It requires a TTY and exits with an error in a non-interactive shell.
