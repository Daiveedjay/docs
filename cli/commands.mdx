...
Fourteen commands, covering scanning, dependency audits, CVE gating, SBOM export, agent rules, enforcement and hooks. Anything marked **Pro** needs a licence; the rest work with no account at all.
