...
description: "Full reference for all thirteen Iris Code CLI commands: iris check, iris secrets, iris security, iris deps, iris cve, iris sbom, iris todos, iris gate, iris slack, iris report, iris hook, iris auth, and iris config."
---
...
**Pro.** Exports a CycloneDX 1.5 software bill of materials covering npm, Go, Python, RubyGems, and NuGet manifests in the project. The command is fully offline: no network requests are made and no consent prompt appears.
