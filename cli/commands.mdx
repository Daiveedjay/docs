...
description: "Full reference for all fourteen Iris Code CLI commands: iris check, iris secrets, iris security, iris deps, iris cve, iris sbom, iris todos, iris gate, iris slack, iris rules, iris report, iris hook, iris auth, and iris config."
---
