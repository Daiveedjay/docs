...
description: "Iris natively parses and scores TypeScript, JavaScript, Go, and Python with per-language function detection, import tracking, and debug-print flagging."
---
