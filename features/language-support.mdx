...
<Tabs>
  <Tab title="TypeScript & JavaScript">
    Iris Code scans `.js`, `.jsx`, `.ts`, and `.tsx` files with a single TS/JS parser. All four extensions are treated as the same language family and share the same rule set.
