---
title: "Supported Languages: TypeScript, JavaScript, Vue, Svelte, Go, Python, Ruby"
sidebarTitle: "Language Support"
description: "Iris Code natively parses and scores TypeScript, JavaScript, Vue, Svelte, Go, Python, and Ruby with per-language function detection, import tracking, and debug-print flagging."
---

Five languages, each with its own parser, plus Vue and Svelte components whose script blocks go through the JavaScript or TypeScript one.
