---
title: "Security Smell Detection: Nine Patterns Across TS, JS, Go, Python, Ruby, and C#"
...
badge: "New"
keywords: ["C#", "c sharp", "csharp", ".NET", "dotnet", "ASP.NET", "catch-all exception", "async void", "SQL injection", "open redirect", "weak hashing", "insecure random", "TLS verification"]
---
...
All nine are detected across TypeScript, JavaScript, Go, Python, Ruby and C# wherever they apply, and `enableSecuritySmells` enables or disables the group.
