...
| **Language badge** | Go, TypeScript, JavaScript or Python, in the header |
...
<Note>
  Unused *import* detection is TypeScript and JavaScript only. Go and Python handle unused imports at the compiler or runtime level, so Iris Code does not duplicate that.
</Note>
