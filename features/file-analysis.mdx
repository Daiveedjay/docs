...
description: "Iris analyses every file on open and save: 0–100 health score, complexity, function list, code smells, TypeScript metrics, and secrets detection."
---
...
Iris detects nine security anti-patterns across all supported languages. Each finding counts toward **Blockers** — the same category as hardcoded secrets — and is clickable to jump to the exact line.
