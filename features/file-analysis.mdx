---
title: "File analysis: understand scores, findings, and function metrics"
sidebarTitle: "File Analysis"
description: "Understand the health score, complexity, functions, code smells, security findings, and committed credentials reported for the open file."
keywords: ["C#", "c sharp", "csharp", ".NET", "dotnet", ".cs", "Java", ".java", "Rust", ".rs", "method detection", "unused imports", "language badge"]
---
