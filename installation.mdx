---
title: "Install Iris Code in an editor or terminal"
sidebarTitle: "Installation"
description: "Install Iris Code from the VS Code, Open VSX, or JetBrains marketplace, use a VSIX package, or add the CLI for terminals and CI."
---
