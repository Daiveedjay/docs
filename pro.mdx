...
description: "Iris Code Pro adds repeatable workspace scans, configured gates, hooks, CI workflows, dependency intelligence, and opt-in Cloud audits. Start a 14-day trial without a card."
---
...
- **Cloud audits** - connect a GitHub repository and it is audited without your editor open, with every report pinned to the commit that produced it. Includes **50 scans a month**; see [Cloud overview](/cloud/overview) and [Scan allowances](/cloud/allowances)
...
- **Account Analytics** - your health trend plus a private timeline of scans, hook results, blocked pushes, completed cloud audits and other recorded signals
- **Personal audit history** - one commit-pinned history of cloud audits across all repositories connected to your Solo workspace
