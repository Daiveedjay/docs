...
| `Iris Code: Analyse Workspace` | Analyse all JS/TS/Vue/Svelte/Go/Python/Ruby/C# files in the workspace |
...
- Right-click a **JS/TS/Vue/Svelte/Go/Python/Ruby/C# file** → **Iris Code: Analyse This File**
