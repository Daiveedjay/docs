...
| `Iris Code: Analyse Workspace` | Analyse all JS/TS/Vue/Svelte/Go/Python/Ruby files in the workspace |
...
| `Iris Code: Install Build Hook` | Wire Iris Code health checks into the project build - `prebuild` for Node, Makefile target for Go, Python, and Ruby |
...
- Right-click a **JS/TS/Vue/Svelte/Go/Python/Ruby file** → **Iris Code: Analyse This File**
