---
title: "Iris VS Code Command Palette Reference"
...
| `Iris: Install Build Hook` | Wire Iris health checks into the project build |
| `Iris: Uninstall Build Hook` | Remove the Iris build hook, leaving other build steps intact |
