...
<AccordionGroup>
  <Accordion title="A repository shows 'allowance used'">
  ...
  <Accordion title="A repository shows the connection needs attention">
  ...
  <Accordion title="Pushes are not triggering audits">
  ...
  <Accordion title="An audit has been queued for a long time">
