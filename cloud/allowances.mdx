---
title: "Scan Allowances: How Many Cloud Scans You Get, and How They Are Counted"
sidebarTitle: "Scan allowances"
description: "Pro includes 50 cloud scans a month and a team includes 100 per seat. Every audit counts one, whoever started it, and allowances never merge between workspaces."
---

A cloud scan costs one scan. The rule is deliberately that simple: **every audit counts one, whoever or whatever started it.**
...
- Your account spends your Pro allowance
- Each team spends that team's allowance
- Being in two teams means two separate pools, both usable, neither shared

<Warning>
  A team seat does **not** give you cloud scans for your own repositories. A seat covers that team's repositories; auditing your own needs your own Pro subscription. This is the one case where holding both is genuinely useful rather than duplicated - see [Team entitlement](/teams/entitlement).
</Warning>
