...
description: "Install the Iris build hook to run a health check before every pnpm build, npm run build, or make build. Builds that fail the threshold are stopped before compilation."
---
