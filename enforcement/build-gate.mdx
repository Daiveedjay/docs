...
Every build hook run is recorded as a pass or fail in your account Analytics, so enforcement activity is visible without reading build logs. See [iriscode.co/account/analytics](https://www.iriscode.co/account/analytics).
