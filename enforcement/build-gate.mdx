---
title: "Build gate: check project standards before compilation"
sidebarTitle: "Build Gate"
description: "Run the configured Iris Code gate before the compiler starts and stop the build when project limits fail."
