---
title: "Hardcoded Secrets Detection in Iris"
sidebarTitle: "Secrets Detection"
description: "Iris scans every file for leaked credentials using two layers: suspicious variable names and known token formats. Each finding deducts 10 points from the health score."
---
