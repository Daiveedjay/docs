...
description: "Gate Preview runs a read-only workspace scan against all five built-in presets so you can see how many files would be blocked before enabling any hook."
---
