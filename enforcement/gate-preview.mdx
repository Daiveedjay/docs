---
title: "Gate Preview: compare project results before enabling enforcement"
sidebarTitle: "Gate Preview"
description: "Compare the project with five built-in gate presets before writing configuration, installing a hook, or blocking a push."
---

Installing enforcement without knowing what it will block is how a gate ends up being switched off a day later.

Gate Preview scans your project and shows how it scores against all six presets at once, before anything is enabled. It is read-only: no config is written and no push is blocked until you choose to act on it.
...
| `ai-assisted` | 82 | Reviewing AI-assisted code at volume. Tightens structural, security, suppression and duplication defaults without imposing a naming convention |
