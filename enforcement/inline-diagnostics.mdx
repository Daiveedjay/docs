...
description: "Opt in to surface Iris findings as editor squiggles and VS Code Problems panel entries. Off by default to keep the Problems panel clean. Configure per-category."
---
