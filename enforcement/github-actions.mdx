...
description: "Add Iris health checks to GitHub Actions to block merges when files fall below your threshold. Get inline PR annotations at failing lines. Requires Iris Pro."
---
