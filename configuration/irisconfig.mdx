---
title: "Configure Iris with .irisconfig.json"
sidebarTitle: ".irisconfig.json"
description: "Drop a .irisconfig.json at your project root to share thresholds across your team. Supports config presets, custom thresholds, gate limits, and severity overrides."
---
...
| `enableInlineDiagnostics` | `true` | Master toggle for squiggles and Problems panel entries |
