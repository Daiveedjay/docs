...
description: "Config Studio is a visual editor in your account dashboard. Pick a preset, tune thresholds, and sync the resulting .irisconfig.json to VS Code with a diff preview."
---
