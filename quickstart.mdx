---
title: "Quick start: install Iris Code and review your first project"
sidebarTitle: "Quick Start"
description: "Install Iris Code, inspect a file, run the first workspace scan, and preview the configured gate without creating an account."
---
...
<Steps>
  ...
  <Step title="Run your free workspace scan">
    Command palette (`Ctrl+Shift+P` / `Cmd+Shift+P`), run **Iris Code: Scan Workspace**.
    ...
    Your first full workspace scan is free, stays on your machine, and requires no account. Iris Code saves it, so the files, issues, TODOs and duplicates remain available without scanning again.
  ...
  <Step title="Preview your enforcement posture">
    At the bottom of the **File tab**, click **Preview Gate**. Iris Code runs a background scan and shows how your project scores against all six presets:
    ...
    | **AI-assisted** | 82 | Reviewing AI-assisted code at volume, without imposing a naming convention |
