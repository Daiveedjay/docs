...
Iris Code activates on JavaScript, TypeScript, JSX, TSX, Vue, Svelte, Go, Python, Ruby and C# files, and on any workspace containing a `.csproj`. Its icon appears in the Activity Bar.
</Step>
