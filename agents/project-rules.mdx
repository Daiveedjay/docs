---
title: "Project Rules: Generate Agent Instructions from Your Iris Code Config"
sidebarTitle: "Project rules"
description: "Use iris rules to write the project's configured limits, naming conventions, and gate rules into the instruction files supported coding agents already read."
---
