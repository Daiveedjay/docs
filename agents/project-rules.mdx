...
- It does not check the agent's work. That is what `iris check`, the [git hook](/enforcement/git-hook) and the [MCP server](/agents/mcp) are for, and the generated file points the agent at them.
