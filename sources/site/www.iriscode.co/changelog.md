# Source: https://www.iriscode.co/changelog
...
[Jump to latest](https://www.iriscode.co/#cl-2026-06-17)

[v1.6.1●](https://www.iriscode.co/#cl-2026-06-17) [v1.6.0](https://www.iriscode.co/#cl-2026-06-16) [v1.5.0](https://www.iriscode.co/#cl-2026-06-10) [v1.4.2](https://www.iriscode.co/#cl-2026-06-05) [v1.4.1](https://www.iriscode.co/#cl-2026-06-04) [v1.4.0](https://www.iriscode.co/#cl-2026-06-03) [v1.3.0](https://www.iriscode.co/#cl-2026-05-28) [v1.2.1](https://www.iriscode.co/#cl-2026-05-27) [v1.2.0](https://www.iriscode.co/#cl-2026-05-20) [v1.1.0](https://www.iriscode.co/#cl-2026-05-18) [v1.0.9](https://www.iriscode.co/#cl-2026-05-11) [v1.0.0](https://www.iriscode.co/#cl-2026-04-30) [v1.0.0](https://www.iriscode.co/#cl-2026-04-29) [v1.0.0](https://www.iriscode.co/#cl-2026-04-25) [v0.2.0](https://www.iriscode.co/#cl-2026-04-13) [v0.1.x](https://www.iriscode.co/#cl-2026-04-06) [v0.1.x](https://www.iriscode.co/#cl-2026-03-12)
...
- Added analytics batching: the extension buffers usage events in memory and flushes every 60 seconds. push\_blocked events flush immediately. The buffer survives extension crashes via crash-safe persistence to globalState.
...
- Added iris auth: sign in via browser or licence token, store credentials in ~/.iris/credentials (chmod 600). iris auth login, iris auth logout, and iris auth status. Credentials read from IRIS\_LICENCE\_TOKEN env var first, then credentials file.
...
- Hook install messages in the extension now inform users to run iris auth login or set IRIS\_LICENCE\_TOKEN so the hook can validate at push or build time.
